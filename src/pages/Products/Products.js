...
const Products = () => {
  ...
  useEffect(() => {
    axios
      .get("/getall?page=1&itemStatus=Published&resultsPerPage=10")
  ...
  const productItems = [
    ...
    },
    {
      ...
      ShortDescription:
        "Sweet croissant with blueberries and strawberries inside",
      Price: "8.92",
      Quantity: "3 pcs",
      PictureUrl:
        "https://cdn.pixabay.com/photo/2017/06/30/13/48/coffee-2458300__480.jpg",
    },
    {
      id: 5,
      ...
      ShortDescription: "Sweet croissant with topping almonds and brown sugar",
      PictureUrl:
        "https://cdn.pixabay.com/photo/2015/02/25/13/21/croissant-648803__480.jpg",
    },
    {
      id: 6,
      ...
      ShortDescription: "Sweet croissant with topping almonds and brown sugar",
      PictureUrl:
        "https://cdn.pixabay.com/photo/2022/10/18/15/40/pastries-7530566__480.jpg",
    },
  ];
  return (
    <div className="flex pt-8 ">
      <CssBaseline />
      <Grid item container rowSpacing={2} spacing={0}>
        {Products.map((product) => (
          <Grid key={product.engData._id} item xs={4}>
            <ProductCard key={product.engData._id} product={product} />
          </Grid>
        ))}
      </Grid>
    </div>
